...
<body>
  ...
  <%@include file="/vue/navBar.jsp"  %>
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h3>print All web site accounts</h3>
        <hr width="100%">
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
            <c:forEach items="${userModel.userList}" var="user">
              <tr>
                <td><c:out value="${user.id_user}"></c:out></td>
                <td><c:out value="${user.nom}"></c:out></td>
                <td><c:out value="${user.email}"></c:out></td>
                <td><c:out value="${user.uType}"></c:out></td>
                <td><a href="deletUser?idUser=${user.id_user}"></a>Delete account</td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
