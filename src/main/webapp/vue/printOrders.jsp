      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm">
            ...
            <tbody>
            <c:forEach items="${commandModel.listCommand" var="command">
              <tr>
                <td><c:out value="${command.id_command}"></c:out></td>
                <td><c:out value="${command.clientName}"></c:out></td>
                <td><c:out value="${command.produitNome}"></c:out></td>
                <td><c:out value="${command.delevaryNome}"></c:out></td>
                <td><c:out value="${command.date}"></c:out></td>
                <td><c:out value="${command.quantite}"></c:out></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
